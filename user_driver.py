...
from todonotifier.connect import Connect, ConnectMethod
...
def run():
    ...
    project_dir_name: str = ""  # Placeholder. Generally same as project name and must be empty for `ConnectMethod.DRY_RUN_FILE`
    sender_email = ""
    password = ""
    receivers = []
    host = "smtp.gmail.com"
    ...
    connect = Connect(
        connect_method=ConnectMethod.DRY_RUN_FILE, project_dir_name=project_dir_name, url=git_url, branch_name="production"
